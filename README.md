...
```
sudo yunohost app install --debug https://github.com/liberodark/wordpress_ynh/tree/5.3.x
or
sudo yunohost app upgrade --debug wordpress -u https://github.com/liberodark/wordpress_ynh/tree/5.3.x
```
